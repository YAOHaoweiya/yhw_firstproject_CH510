...
ALIGNED_HEAD static uint8_t g_usbd_descriptor[USB_DEVICE_DESC_LEN] ALIGNED_TAIL =
{
  ...
  1                                      /* bNumConfigurations */   /* bNumConfigurations */
};
...
ALIGNED_HEAD static uint8_t g_usbd_configuration[USBD_CUSHID_CONFIG_DESC_SIZE] ALIGNED_TAIL =
{
  ...
  0xFA,                                  /* MaxPower 250 mA: this current is used for detecting vbus */
  ...
  CUSHID_BINTERVAL_TIME,                    /* bInterval: interval for polling endpoint for data transfers */               /* bInterval: interval for polling endpoint for data transfers */
};
